...
public class Tileset {
    ...
    public static final TETile CACTUS = new TETile('♣', new Color(0, 128, 0), new Color(237, 201, 175), "cactus", 13);
    public static final TETile PEACH = new TETile('☺', new Color(255, 180, 80), Color.black, "peach", 14);
    public static final TETile ICE = new TETile('≈', new Color(173, 216, 230), Color.white, "ice", 15);
    public static final TETile SNOW = new TETile('❄', Color.white, new Color(200, 200, 200), "snow", 16);
